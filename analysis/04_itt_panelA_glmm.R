...
data1 <- read_excel("data/LungDiag_itt_imputed_na_as_incorrect.xlsx")
...
doc <- body_add_par(
  doc,
  value = "Panel A: LungDiag assigned-but-unanswered items coded as incorrect; control assigned-but-unanswered items coded as correct",
  style = "Normal"
)
