# This script prepares the LungDiag-GPT4o-arm ITT dataset for Panel C analysis by
# imputing baseline variables and recoding selected unanswered questionnaire items as incorrect.
...
output_name <- "data/LungDiag-GPT4o_itt_panelC_na_as_incorrect.xlsx"
